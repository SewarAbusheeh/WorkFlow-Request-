...
namespace Newone.Areas.AdminDashboard.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,CreationDate,IsDeleted,IsActive")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,CreationDate,IsDeleted,IsActive")] Category category)
        {
