...
namespace Newone.Areas.UserDashboard.Controllers
{
    public class EditUserController : Controller
    {
        ...
        public EditUserController(UserManager<ApplicationUser> userManager, IWebHostEnvironment hostEnvironment,
        ...
        private string UploadNewFile(EditprofileViewModel model)
        {
